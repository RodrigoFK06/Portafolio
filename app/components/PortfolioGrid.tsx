          ...
          <AnimatePresence>
            {filteredProjects.map((project) => (
              <motion.div
                ...
                className="bg-background rounded-3xl shadow-lg overflow-hidden hover-lift transition-all duration-300 ease-in-out border border-border hover:border-primary/30"
              >
